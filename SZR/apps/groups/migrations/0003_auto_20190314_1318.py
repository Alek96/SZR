...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('authentication', '0003_auto_20190314_1318'),
        ('groups', '0002_auto_20190113_0509'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='addgroupmembertask',
            name='new_user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='authentication.GitlabUser'),
        ),
        migrations.AddField(
            model_name='addgroupmembertask',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owned_tasks_addgroupmembertask', to='authentication.GitlabUser'),
        ),
        migrations.AddField(
            model_name='addgroupmembertask',
            name='task_group',
